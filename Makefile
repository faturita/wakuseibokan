...
SCS = src/usercontrols.cpp src/savegame.cpp src/camera.cpp src/odeutils.cpp src/map.cpp src/board.cpp src/hud.cpp src/imageloader.cpp src/ThreeMaxLoader.cpp src/md2model.cpp src/math/vec3f.cpp src/propertystore.cpp src/math/yamathutil.cpp src/openglutils.cpp src/FractalNoise.cpp src/math/uuid.cpp src/terrain/Terrain.cpp src/font/DrawFonts.cpp $(shell ls src/units/*.cpp) $(shell ls src/structures/*.cpp) $(shell ls src/actions/*.cpp) $(shell ls src/weapons/*.cpp) src/sounds/sounds.cpp src/sounds/soundtexture.cpp src/engine.cpp src/entities.cpp src/commandline.cpp src/control.cpp src/ai2.cpp src/profiling.cpp src/networking/telemetry.cpp src/networking/ledger.cpp src/networking/lobby.cpp
