...
void drawScene() {
    ...
    drawArrow();
    /**drawBox(_textureId,10,10,-40);
    drawBox(_textureId,10,20,-80);
    
    drawBox(_textureId,10,10,10);
    drawBox(_textureId,-10,-10,-10);
    
    drawBox(_textureId,50,50,50);
    drawBox(_textureId,113,45,22);
    drawBox(_textureId,50,50,50);
    drawBox(_textureId,313,45,22);
    drawBox(_textureId,-32,13,-50);
    drawBox(_textureId,13,45,222);
    drawBox(_textureId,250,50,50);
    drawBox(_textureId,87,45,222);**/
