...
TestCase_118::TestCase_118()
{

}

void addOtter(Vec3f pos, float angle, int faction)
{
    // 6,3,12
...
void TestCase_118::init()
{
    ...
    addOtter(Vec3f(0,5,+500), 0,GREEN_FACTION);
    addOtter(Vec3f(0,5,-500), 0, BLUE_FACTION);
...
int TestCase_118::check(unsigned long timertick)
{
    ...
    if (!_b)
    {
        ...
        float estimatedtimemilliseconds = ((100 * 2.0)*1000.0)/(9.81);
...
int TestCase_118::number()
{
    return 118;

}

std::string TestCase_118::title()
{
    return std::string("Consistency of bullet firing.");
}


bool TestCase_118::done()
{
    return isdone;
}
bool TestCase_118::passed()
{
    return haspassed;
}
std::string TestCase_118::failedMessage()
{
    return message;
}
